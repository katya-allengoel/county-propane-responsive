...
var stickyNavTop = (0, _jquery2.default)('.navbar').offset().top;
var stickyNav = function stickyNav() {
    var scrollTop = (0, _jquery2.default)(window).scrollTop();

    if (scrollTop > stickyNavTop) {
        (0, _jquery2.default)('.navbar').addClass('navbar--fixed');
    } else {
        (0, _jquery2.default)('.navbar').removeClass('navbar--fixed');
    }
};
...
var _flickity = __webpack_require__(11);

var _flickity2 = _interopRequireDefault(_flickity);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var flky = new _flickity2.default('.banner__slider', {
